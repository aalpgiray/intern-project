...
var App = /** @class */function () {
    function App(appElement, dataStore) {
    ...
    App.prototype.save = function () {
        ...
        this.appElement.querySelector('#save').addEventListener('click', function (e) {
            _this.dataStore.addNewWord(_this.appElement.querySelector('#word').value, _this.appElement.querySelector('#meanings').value.split(','));
        });
    };
    App.prototype.lookup = function () {
        var _this = this;
        this.appElement.querySelector('#lookup').addEventListener('click', function (e) {
            var meanings = _this.dataStore.lookup(_this.appElement.querySelector('#word').value);
            _this.appElement.querySelector('#meanings').value = meanings.join(',');
        });
    };
...
appInstance.render();
},{"./App/App":7,"./DataStore/DataStore":8}],15:[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + '49105' + '/');
...
//# sourceMappingURL=/translator.61249995.map